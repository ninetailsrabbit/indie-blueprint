...
func create_graphic_quality_preset_buttons() -> void:
	...
	for quality_preset in IndieBlueprintHardwareDetector.graphics_quality_presets:
		...
		button.button_pressed = int(quality_preset) == int(IndieBlueprintSettingsManager.get_graphics_section(IndieBlueprintGameSettings.QualityPresetSetting))
...
func on_quality_button_pressed(quality_preset_button: BaseButton) -> void:
	IndieBlueprintSettingsManager.update_graphics_section(IndieBlueprintGameSettings.QualityPresetSetting, quality_preset_button.get_meta(IndieBlueprintGameSettings.QualityPresetSetting))
