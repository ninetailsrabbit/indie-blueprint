...
class_name IndieBlueprintGrabbableRayCastInteractor3D extends RayCast3D

var focused: bool = false
var interacting: bool = false
var current_grabbable: IndieBlueprintGrabbable3D
...
func _physics_process(_delta):
	...
	if detected_grabbable is IndieBlueprintGrabbable3D and detected_grabbable.state_is_neutral():
...
func focus(grabbable: IndieBlueprintGrabbable3D):
...
func unfocus(grabbable: IndieBlueprintGrabbable3D = current_grabbable):
